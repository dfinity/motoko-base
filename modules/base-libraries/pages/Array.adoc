...
[source.no-repl,motoko,subs=+macros]
----
func filter<A>(array : pass:[[]Apass:[]], predicate : A -> Bool) : pass:[[]Apass:[]]
----
...
[source.no-repl,motoko,subs=+macros]
----
func mapFilter<A, B>(array : pass:[[]Apass:[]], f : A -> ?B) : pass:[[]Bpass:[]]
----
...
[source.no-repl,motoko,subs=+macros]
----
func foldRight<X, Y>(array : pass:[[]Xpass:[]], base : Y, combine : (X, Y) -> Y) : Y
----
