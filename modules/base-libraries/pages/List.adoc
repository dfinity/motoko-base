...
[source.no-repl,motoko,subs=+macros]
----
func fromArray<A>(xs : [A]) : xref:#type.List[List]<A>
----
...
[source.no-repl,motoko,subs=+macros]
----
func fromVarArray<A>(xs : [var A]) : xref:#type.List[List]<A>
----
...
[source.no-repl,motoko,subs=+macros]
----
func toArray<A>(xs : xref:#type.List[List]<A>) : [A]
----
...
[source.no-repl,motoko,subs=+macros]
----
func toVarArray<A>(xs : xref:#type.List[List]<A>) : [var A]
----
