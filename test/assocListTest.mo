...
let suite = Suite.suite(
    ...
    [
        ...
        Suite.test(
            ...
            // FIXME the documentation and type signature makes me expect the following result:
            // assocListTest([(0, 10), (4, 14), (2, 24), (1, 11)]),
            // i.e., to combine the values of colliding keys using the provided lambda
        ),
        Suite.test(
