...
func listRes(item : Result.Result<List.List<Nat>, Text>) : T.TestableItem<Result.Result<List.List<Nat>, Text>> {
  let resT = T.resultTestable(T.linkedListTestable(T.intTestable), T.textTestable);
  { resT with item }
};
...
let replicate = Suite.suite(
  ...
  [
    Suite.test(
      ...
      M.equals(
        T.linkedList(T.natTestable, List.nil<Nat>())
      )
    ),
    Suite.test(
      "small-list",
...
let tabulate = Suite.suite(
  ...
  [
    ...
    Suite.test(
      ...
      M.equals(
        T.linkedList(T.natTestable, List.replicate(10000, 0))
      )
    )
  ]
);
  ...
  [
    Suite.test(
      ...
      List.partition<Nat>(
       List.nil<Nat>(),
       func n { n % 2 == 0 }),
      M.equals(T.tuple2(T.linkedListTestable(T.natTestable),
                        T.linkedListTestable(T.natTestable),
...
let zip = Suite.suite(
  ...
  [
    Suite.test(
      ...
      M.equals(
        T.linkedList(T.tuple2Testable(T.natTestable,T.natTestable),
